...
const localEvent = JSON.parse(localStorage.getItem("event-fav")) || [];
function Cards(props) {
  // const [favoriState, setFavoris] = useState(false);
  const recordCard = props.recordState;
  console.log(recordCard);
  //   const recordCardId = props.id;

 

  // console.log(localEvent)
  // useEffect(() => {
  //   if(localEvent.includes(recordCard)){
  //       setFavoris(true)
  //   }
  ...
  //   );
  //   localStorage.setItem("event-fav", JSON.stringify(item));
  //   setFavoris(false);
  // }
    ...
    <div className="justify-content-center m-auto container ">
      {recordCard && (
        <Card className="m-auto card mt-5" style={{ width: "25rem" }}>
          ...
          >
            <Card.Img className="card-image" variant="top" src={recordCard.record.fields.cover_url} />
            <Card.Body>
          ...
          <Card.Footer>
            ...
            {/* {favoriState ? (
              <button className="heart" onClick={() => removeFavoris(recordCard)}>
                <svg
              ...
              <button className="heart" onClick={() => addFavoris(recordCard)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
